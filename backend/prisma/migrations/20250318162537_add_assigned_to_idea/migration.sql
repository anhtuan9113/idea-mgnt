...
INSERT INTO "new_Idea" ("authorId", "category", "createdAt", "description", "id", "solution", "status", "tags", "title", "updatedAt") SELECT "authorId", "category", "createdAt", "description", "id", "solution", "status", "tags", "title", "updatedAt" FROM "Idea";
DROP TABLE "Idea";
